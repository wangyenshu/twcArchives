...
Wikitext linking to a space on another server, for example from a tiddler in a space on tiddlyspace.gir.dk to a tiddler or a space on example.com, isn't currently supported. 
!!Code
***/
//{{{
