...
--><input type='button' value='<' title='tilbage' style='width:3%'
	onclick='try{window.frames["player_%id%"].history.go(-1)}catch(e){window.history.go(-1)}' ><!--
--><input type='button' value='>' title='frem' style='width:3%'
	onclick='try{window.frames["player_%id%"].history.go(+1)}catch(e){window.history.go(+1)}'><!--
--><input type='button' value='+' title='opfrisk'style='width:3%'
	onclick='try{window.frames["player_%id%"].location.reload()}catch(e){;}'><!--
--><input type='button' value='x' title='slut'style='width:3%'
	onclick='window.stop()'><!--
...
--><input type='button' value='tilføj' title='føj URL til bogmærker' style='width:6%'
	favorites="%favorites%"
	onclick='config.macros.miniBrowser.add(this.form.url,this.getAttribute("favorites"));'><!--
--><input type='button' value='slet' title='fjern URL fra bogmærker' style='width:6%'
	favorites="%favorites%"
	onclick='config.macros.miniBrowser.del(this.form.bookmarks,this.getAttribute("favorites"));'><!--
--><input type='button' value='redigér' title='redigér bogmærkelisten' style='width:6%'
	favorites="%favorites%"
	onclick='story.displayTiddler(null,this.getAttribute("favorites"),2)'><!--
--></span><!--
--><span style='display:%shownav%'><!--
--><input name=previous type='button' value='&#x25C4;' title='se forrige bormærke' style='width:3%'
...
--><input name=next type='button' value='&#x25BA;' title='se næste bogmærke' style='width:3%'
	onclick='var b=document.getElementById("minibrowser_bookmarks_%id%");
...
--><input type='text' name='url' id='minibrowser_url_%id%' size='60' value='' style='width:%urlsize%'
	onfocus='this.select()'><!--
--><input type='submit' value='gå' title='se URL' style='width:6%'><!--
--><input type='button' value='åbn' title='åbn i separat fane/vindue' style='width:6%'
	onclick='if (this.form.url.value.length) window.open(this.form.url.value)'><!--
--><input type='button' value='afslut' name='done' disabled title='afbryd fra URL' style='width:6%'
