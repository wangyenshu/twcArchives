...
//        if (params[0] === 'new') {
            ...
            bookmarklet = "javascript:(function(a,b)%7Ba=b.createElement('script');a.setAttribute('src','http://" + spaceName + ".tiddlyspace.gir.dk/bookmarker-loader.js');b.body.appendChild(a);a.addEventListener('load',function()%7BloadBookmarker('http://" + spaceName + ".tiddlyspace.gir.dk/bookmarker','" + spaceName + "');%7D,false);%7D(null,document))";
//        } else {
